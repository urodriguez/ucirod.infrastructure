        ...
        public string LoggingConnectionString
        {
            get
            {
                switch (Environment.Name)
                {
                    ...
                    case "TEST": return  "Server=localhost;Database=UciRod.Infrastructure.Logging123-Test;User ID=ucirod-infrastructure-user;Password=uc1r0d-1nfr45tructur3-user;Trusted_Connection=True;MultipleActiveResultSets=true";
